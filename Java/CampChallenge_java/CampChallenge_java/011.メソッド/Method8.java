...
public class Method8 extends HttpServlet {
     ...
     */
       ...
       String[] datas1 = {"1","技育太郎","東京",null,"プログラマー"};
       
       String[] datas2 = {"2",null,"北海道","女","システムエンジニア"};
       
       String[] datas3 = {"3","技育三郎","大阪","男",null};
        ...
        try (PrintWriter out = response.getWriter()) {           
            ...
            for(int i = 0; i < data.length; i++){
                ...
                if(i == 0 ){
                    ...
                    // data[i].equals("null") でも可能（文字列の比較）
                    continue;
                }
               out.print(data[i]);
            }
